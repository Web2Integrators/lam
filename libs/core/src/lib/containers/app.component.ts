...
import * as fromRoot from '@lamresearch/lam-common-eager';

import { AuthActions } from '@lamresearch/auth';
...
export class AppComponent {
  ...
  constructor(private store: Store<fromRoot.AppState & fromAuth.State>) {
    /**
